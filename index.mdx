...
<!--
Welcome, everyone! Today we're going to talk about designing and developing user interfaces in 2024. We'll explore modern approaches to creating consistent, efficient, and user-friendly interfaces. This lecture will help you understand the challenges of building large-scale projects and introduce you to the concept of design systems.
-->
...
major focus. I started with libraries of components about 15 years ago,
...
4. Finally, we'll dive into design systems, which bring all these concepts together.
...
<!--
Now, let's talk about CSS. Many developers think CSS is easy, but it can be tricky, especially in big projects. Let's look at some common CSS challenges.
-->
...
This global nature makes it hard to write CSS for specific parts of your site without accidentally changing other parts. It's especially tricky when you're working on a library or code that will be used on different websites.
-->
...
<!--
This is what we call "specificity hell." It's when you have to write increasingly complex selectors just to apply simple styles. 
...
<!--
This meme perfectly captures how frustrating CSS specificity can be! Sometimes, no matter what you do, your styles just won't apply. It feels like you're fighting against the CSS itself. This is why we need better ways to organize our CSS in large projects.
-->
...
When writing CSS, you provide criterias for the nodes to whihc this CSS should be applied. If we make an analogy with writing and address on an envelop, deterministic approach would be to write as we usually do: Konemiehentie 2, Espoo, Finland. While with non-deterministic approach — as wwe do in CSS — we write "a house on a small street with a green tree near it and a see in 2 blocks".
...
<!--
This meme shows how CSS can sometimes feel like a guessing game. You might think you know what your CSS will do, but then it surprises you! This unpredictability is why we need more structured approaches to CSS in large projects.
-->
...
On the left, we see simple CSS properties. These aren't the hard part of CSS. You can easily learn how to make text bold or change colors.

On the right, we see the selector. This is where CSS gets tricky. Deciding how to structure your selectors, managing specificity, and ensuring your styles apply where you want (and only where you want) - these are the real challenges in CSS.

Understanding these challenges is the first step to writing better, more manageable CSS in large projects.
-->
...
These problems show why we need a more structured approach to building user interfaces.
-->
...
This method helps solve many of the problems we saw with traditional CSS and JavaScript development.
-->
